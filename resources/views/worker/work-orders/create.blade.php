                            ...
                            <div x-show="assetType === 'truck'" x-cloak class="mt-6 space-y-4 bg-gray-50 p-4 rounded-lg">
                                ...
                                <div class="border-t pt-4">
                                    <label class="flex items-start gap-2 cursor-pointer">
                                        <input type="checkbox" name="oil_service" value="1" x-model="oilService"
                                               class="mt-1 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                        <span class="text-sm text-gray-900">
                                            {{ __('This job is an oil service') }}
                                            <span class="block text-xs text-gray-500">
                                                {{ __('You confirm the KM and that the oil was changed when you complete the job.') }}
                                            </span>
                                        </span>
                                    </label>
    ...
    <script>
        function workOrderForm() {
            return {
                ...
                oilService: {{ old('oil_service') ? 'true' : 'false' }},
                kmSource: null,
                loadingKm: false,
                ...
                fetchKm(fresh = false) {
                    ...
                    const url = '{{ route('worker.work-orders.truck-km') }}'
                ...
                validateForm() {
                    ...
                    // The due date may be in the past: work is sometimes entered into
                    // the system after it was carried out.
