{{-- resources/views/admin/service-templates/create.blade.php --}}
<x-app-layout>
    <x-slot name="header">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            <label class="inline-flex items-center">
                                <input type="checkbox" name="is_active" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" 
            ...
            <div class="md:col-span-2" x-show="item.requires_photo">
                ...
                <textarea
                    ...
                    placeholder="Provide specific instructions for what photos should be taken (e.g., 'Take a clear photo of the serial number')"></textarea>
                            ...
                            <x-input-error :messages="$errors->get('checklist_items')" class="mt-2" />
                        </div>
                    </div>
